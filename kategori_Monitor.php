...
$log=mysqli_query($connect,"insert into log(ip_user,activity,date) values (NULL,'$ip_user','$activity','$date')");
?>
<!DOCTYPE html>
<html lang="en">
    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav ml-auto my-2 my-lg-0">
          <li class="nav-item">
            <a class="nav-link js-scroll-trigger" href="home.php?=home">Home</a>
          </li>
          <li class="nav-item">
...
BEFORE !! MOVE CATEGORY ADD CART FIRST</h2>
  ...
  <thead>
    ...
    $i=1;
    $j=0;
    $link = mysqli_query($connect,"select *from barang where model='monitor'");
  ...
  <tbody>
    <tr>
      <th scope="row"><?=$i++;?>.</th>
      <td><img src="<?='img/'.$tampung->gambar?>" alt="monitor" width="100"></td>
